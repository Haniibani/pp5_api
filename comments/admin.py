...
class CommentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('created_at', 'updated_at')  # Mark fields as read-only if needed

    fieldsets = (
        (None, {
            'fields': ('owner', 'post', 'content')
        }),
        ('Timestamps', {
    ...
    def save_model(self, request, obj, form, change):
        # Override the save_model method if you need to perform any additional actions
